        ...
        <section className="mb-8 flex grid-cols-1 flex-col items-center justify-center gap-2 pt-10 md:grid lg:grid-cols-2">
          <div className="container mb-6 px-10 text-left md:mb-0 md:px-6 xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            ...
            <div className="mt-2 text-slate-800 dark:text-gray-200">
              <p>
                Redonnez vie à vos meubles avec notre service de nettoyage à
                domicile pour canapés et sièges en tissu. Grâce à notre
                shampouineuse, nous éliminons en douceur les taches tout en
                préservant la texture des tissus. Notre équipe dédiée assure un
                traitement minutieux pour une fraîcheur durable. Réservez dès
                maintenant pour une nouvelle jeunesse à vos tissus.
              </p>
            </div>
          </div>
          <ComparisonSlider topImage="/14.jpg" bottomImage="/12.jpg" />
        </section>

const MentionLegales = () => {
  return (
    <>
      <div className="bg-white px-10 pb-10 pt-20 text-[#101314] dark:bg-[#000302] dark:text-white md:p-28">
        <h1 className="text-3xl font-bold">
          Mentions Légales d'AK CLEAN SERVICE
        </h1>
        <p className="text-sm">
          <strong>Date de la Dernière Mise à Jour :</strong> 31/08/2025
        </p>
        ...
        <section className="mt-6">
          ...
          <p>Téléphone : 1007 </p>
          <p>A CHANGER QUAND ON HEBERGERA LE SITE</p>
        </section>
        ...
        <section className="mt-6">
          ...
          <p>
            ...
            akcleanservice69@gmail.com ou en appelant 06 50 40 08 96.
          </p>
        </section>
      </div>
    </>
